...
RunConfiguration.setExecutionSettingFile('C:\\Users\\work1\\AppData\\Local\\Temp\\Katalon\\Test Cases\\Checkout (Live, IR)\\20180531_161440\\execution.properties')
...
not_run: WebUI.navigateToUrl('https://www.interrail.eu/', FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.click(findTestObject('IR/1st tst/i agree'), FailureHandling.STOP_ON_FAILURE)
...
''', 'Test Cases/Checkout (Live, IR)', new TestCaseBinding('Test Cases/Checkout (Live, IR)', [:]), FailureHandling.STOP_ON_FAILURE , false)
